  ...
  fun customOpenAPI(): OpenAPI = OpenAPI()
    .servers(
      listOf(
        ...
        Server().url("https://prisoner-finance-sync-api.hmpps.service.justice.gov.uk").description("Production"),
    ...
    .info(
      Info().title("HMPPS Prisoner Finance Sync Api").version(version)

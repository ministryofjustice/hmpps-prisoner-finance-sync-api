...
class WebClientConfiguration(
  ...
  @param:Value("\${api.general-ledger.url}") private val generalLedgerApiBaseUri: String,
  ...
  @Bean("generalLedgerApiWebClient")
  fun generalLedgerWebClient(builder: WebClient.Builder): WebClient = builder
    .baseUrl(generalLedgerApiBaseUri)
    .build()
}

...
data class SyncTransactionReceipt(
  ...
  @field:Schema(
    description = "The unique identifier of the **NOMIS transaction**. This Id was provided by the client.",
    example = "12345",
    required = true,
  )
  ...
  enum class Action {
    ...
    @Schema(description = "The request was processed, but errors prevented it from creating a new transaction.")
    PROCESSED_WITH_ERRORS,
  }

  override fun toString(): String = "{ requestId: $requestId, transactionId: $transactionId, synchronizedTransactionId: $synchronizedTransactionId, action: $action }"
}
